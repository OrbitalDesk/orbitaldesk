...
import { Package, LayoutDashboard, DollarSign, ShoppingCart } from 'lucide-react';
import { Card, CardContent, CardFooter, CardHeader, CardTitle } from '@/components/ui/card';

export default function DashboardPage(props: { id: number; data: { products: number; revenue: string; orders: number } }) {
  if (props.id === 1) {
    return (
